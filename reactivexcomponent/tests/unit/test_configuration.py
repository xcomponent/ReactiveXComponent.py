...
class TestConfiguration(unittest.TestCase):
    ...
    def setUp(self):
        self.configuration = APIConfiguration("tests\\unit\\data\\WebSocket_NewDevinetteApi_test.xcApi")
        self.configuration.get_xml_content()
    ...
    def test_get_publisher_details(self):
        ...
        self.assertEqual(publisher, correct_publisher)
