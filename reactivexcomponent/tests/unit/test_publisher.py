...
class TestPublisher(unittest.TestCase):
    ...
    def testget_component_code(self):
        ...
        with self.assertRaises(Exception):
            self.p.get_component_code(component_name)
    ...
    def test_get_state_machine_code(self):
        ...
        with self.assertRaises(Exception):
            self.p.get_state_machine_code('New')
    ...
    def test_get_publisher_details(self):
        ...
        publish = self.p.get_publisher_details(-725052640,-2027871621,'XComponent.Devinette.UserObject.CheckWord')
        ...
        message_type = 'type'
        with self.assertRaises(Exception):
            self.p.get_publisher_details(component_code,state_machine_code,message_type)
